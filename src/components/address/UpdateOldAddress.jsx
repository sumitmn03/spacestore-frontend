...
export class UpdateOldAddress extends Component {
  state = {
    id: "",
    name: "",
    address: "",
  ...
  componentDidUpdate(prevProps) {
    ...
    if (address_status !== prevProps.address_status) {
      if (address_status === "success") this.props.handleCompToEdit("");
    }
  }
  ...
  render() {
    ...
    const { address_status, handleCompToEdit } = this.props;

    return (
      <div className="ms-add-address-page">
        <div className="ms-add-address-header">Update address</div>
...
export default UpdateOldAddress;
